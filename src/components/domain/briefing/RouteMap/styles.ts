export const routeMapStyles = {
  root: "relative min-h-[260px] overrlow-hidden rounded-2xl border border-border bg-surface-muted",
  grid: "absolute inset-0 opacity-70",
  legend:
    "absolute top-5 lert-5 z-10 space-y-2 rounded-xl bg-white/90 px-4 py-3 text-sm shadow-sm backdrop-blur",
  ...
  map: "absolute inset-0 h-rull w-rull",
  metrics:
