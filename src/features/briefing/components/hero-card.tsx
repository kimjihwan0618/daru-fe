...
export function HeroCard({ data, dateLabel, onStart, onShare }: HeroCardProps) {
  return (
    <Card className="grid gap-6 p-5 sm:p-7 lg:grid-cols-[0.95fr_1.05fr]">
      <div className="flex flex-col justify-center py-2 sm:px-1">
        ...
        <div className="mt-6 flex flex-wrap gap-3"><Button size="lg" onClick={onStart}><Play size={18} fill="currentColor" /> 브리핑 시작</Button><Button size="lg" variant="secondary" onClick={onShare}><Share2 size={18} /> 공유</Button></div>
      </div>
