export const briefingModalStyles = {
  root: "fixed inset-0 z-[60] grid place-items-center p-5",
  backdrop: "absolute inset-0 bg-brand-900/60 backdrop-blur-sm",
  panel:
    "animate-fade-up relative z-10 w-full max-w-[580px] rounded-card border border-border bg-white p-7 shadow-card sm:p-9",
  close:
